...
<div id=MainArea>
    ...
    <s:form action="departmentAction_departmentAdd.do" method="POST">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            <s:select name="parentId" list="departmentList" listKey="id" listValue="departmentName" headerKey="" headerValue="=====请选择=====" cssClass="SelectStyle"></s:select>
